...
class Apis {
      ...
      var res = await post(Uri.parse('https://fcm.googleapis.com/fcm/send'),
          headers: {
            ...
            HttpHeaders.authorizationHeader:
                'key=AAAAe32-zsQ:APA91bFu284i1VFDrR6fKcpFI0V134rD5ws8L-4mpSyYspjq15TnXpdUIRXehT02VmEzENlfpWGybWRqNSvlSj5OwMcJOUoLqVj3UrnF7YaE8DQeHrwcGMUMDLnr-RK5m25Up66BMAmt'
          },
  ...
  static Future<void> createUser() async {
    ...
    final chatUser = ChatUser(
      ...
      about: "Hey! I am using TalksIndia",
